...
public class SaveData : ResettableScriptableObject
{
     ...
     * A cada clave (string) le corresponde un valor del tipo que sea
     * */
    ...
    {     
        ...
        /// <summary>
        /// Si existe la clave, sobreescribe su valor. Si no existe, crea una nueva con el valor dado.
        /// </summary>
        ...
        /// <summary>
        /// Busca el valor para una clave dada y lo devuelve si ésta existe
        /// </summary>
        /// <param name="key"></param>
        /// <param name="value"></param>
        /// <returns></returns>
