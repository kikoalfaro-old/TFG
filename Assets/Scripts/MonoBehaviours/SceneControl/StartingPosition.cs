...
{
    string startingPointName;        // The name that identifies this starting point in the scene.
    ...
    {
        startingPointName = SceneManager.GetSceneAt(SceneManager.sceneCount - 1).name; //Estándar de nombre de starting positionç
        //Debug.Log("startingPointName: " + startingPointName);
        // Nombre de la última escena cargada (Actual)
