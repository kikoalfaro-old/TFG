...
public class PositionSaver : Saver
{
    ...
    protected override void Load()
    {
        ...
        // Se pasa por referencia, por lo que la variable position se sobreescribe a través de la función Load y se puede asignar al transformToSave en caso de estar permitido.
    }
}
